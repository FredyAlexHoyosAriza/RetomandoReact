    ...
    return (
        <section>
            ...
            <ul className="breedCardContainer">
                <DogBreedCard Breed="Border Collie" DogImg={borderCollie} likes={150} comments="1.5k" views={120} />
                <DogBreedCard Breed="Pastor Belga Malinois" DogImg={pastorBelgaMalinois} likes={450} comments="1.1k" views={850} />
                <DogBreedCard Breed="Border Collie" DogImg={borderCollie} likes={150} comments="1.5k" views={120} />
                <DogBreedCard Breed="Pastor Belga Malinois" DogImg={pastorBelgaMalinois} likes={450} comments="1.1k" views={850} />
            </ul>
        </section>
